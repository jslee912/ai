...
def get_user():
  ...
  print('name:',name)
  if name:
    return f"<h1>전달받은 이름 {name}님 반갑습니다"
  else:
    abort(404)
# 404에러페이지 처리(예외페이지 처리)
@app.errorhandler(404)
def errorHander(eror):
